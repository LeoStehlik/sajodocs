...
The instructions in the [README.md](https://github.com/derogold/derogold/blob/development/README.md) cover common platforms for compiling from source, it would be impractical to include them all.  
Thus, this page exists to capture the other platforms/distros that DeroGold has been successfully compiled on.  
Please add to it if your environment is not covered, thanks!

## CentOS 7

DeroGold build on CENTOS 7 or RHEL 7 with DEVTOOLS 7
...
### Get DeroGold source and Compile
```
$ cd ..

$ git clone https://github.com/derogold/derogold.git
$ cd derogold
